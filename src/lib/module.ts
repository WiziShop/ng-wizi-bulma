...
@NgModule({
  imports: [NwbSnackbarModule, NwbDialogModule, NwbPaginatorModule, NwbSpinnerModule],
  providers: [OVERLAY_CONTAINER_PROVIDER, DOM_SERVICE_PROVIDER],
  declarations: [],
  exports: [NwbSnackbarModule, NwbDialogModule, NwbPaginatorModule, NwbSpinnerModule],
})
